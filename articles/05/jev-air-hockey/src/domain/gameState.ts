...
export const DEFAULT_STADIUM_CONFIG: StadiumConfig = {
  ...
  // マレットの機動力。低すぎると「読めているのに間に合わない」状態が常態化し、
  // 迎撃点に着くだけで振りかぶる余裕が無くなる。自己対戦の計測では
  // 6000 px/s² でセーブ率 85% / 狙い誤差 24°、12000 px/s² で 99% / 19° になった。
  // 高くしすぎる (20000) と今度は過敏になって狙いが乱れる (30°)。
  maxMalletSpeed: 1050,
  maxMalletAccel: 12000,
